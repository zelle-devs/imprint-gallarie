            ...
            <div className="container-ImprintFooterMain">
                ...
                <div className="col3-ImprintFooterMain col-accordion">
                    ...
                    <div className={`accordion-content ${openSection === 'creators' ? 'open' : ''}`}>
                        <ul className="list-ImprintFooterMain">
                            <li><a href="#application" className="link-ImprintFooterMain">Premium Cases</a></li>
                            <li><a href="/shop-all-products" className="link-ImprintFooterMain">Designer Wallets</a></li>
                            <li><a href="/shop-all-products" className="link-ImprintFooterMain">Designer Bottles</a></li>
                            <li><a href="/shop-all-products" className="link-ImprintFooterMain">Coffee Mugs</a></li>
                            <li><a href="/shop-all-products" className="link-ImprintFooterMain">Printed Wall Art</a></li>
                            <li><a href="/shop-all-products" className="link-ImprintFooterMain">Designer Wall Clocks</a></li>
                        </ul>
                    </div>
                ...
                <div className="bottom-bar-ImprintFooterMain">
                    <div className="bottom-links-ImprintFooterMain">
                        <a href="#products-sitemap" className="bottom-link-ImprintFooterMain">Returns & Refunds</a>
                        <a href="#creators-sitemap" className="bottom-link-ImprintFooterMain">Shipping Policy</a>
                        <a href="#privacy-policy" className="bottom-link-ImprintFooterMain">FAQ</a> 
                    </div>
